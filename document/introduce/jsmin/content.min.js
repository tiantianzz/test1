...
/***/ function(module, exports, __webpack_require__) {
	...
	result.then(function (res) {
		...
		var introduce = ReactDOM.render(React.createElement(Introduce, { name: 'name', content: Content, data: data }), document.body);
	}).catch(function (ex) {
		return console.log('intro.json is loading failed', ex);
	});
