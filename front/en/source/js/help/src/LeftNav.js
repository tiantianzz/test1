		...
		return (
			<div className="left-part">
				...
				<div className="mail-box">
					...
					<div className="info">
						<h2>Email is guaranteed replied within 2 days, please check junk mailbox.Or just contact our CEO directly in Group.</h2>
					</div>
					{/*<div ref="sendEmail" className={"send-email"}>*/}
						{/*<p className="tips">Email is guaranteed replied within 2 days, please check junk mailbox.Or just contact our CEO directly in Group.</p>*/}
						{/*<a href="mailto:service@superbuy.com?spm=2101.892.N.N.1061f70" target="_blank">write an email</a>*/}
					{/*</div>*/}
				</div>
			</div>
		);
