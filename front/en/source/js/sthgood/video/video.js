        ...
        return(
            <div className="video-detail clearfix">
                ...
                <div className="fr clearfix">
                    <a href={this.props.videoData.videoHref} title="Watch on YouTube" target="_blank" className="go-youTube fl"></a>
                    <div className="share-icon fl"title="Share Video">
                        <i className="ico"></i>
                        <div className="border-skip"></div>
                        <div id="bdshare" className="bdsharebuttonbox">
                            <a href="#" className="bds_weixin" data-cmd="weixin" title="Share to Wechat"></a>
                            <a href="#" className="bds_qzone" data-cmd="qzone" title="Share to QQ zone"></a>
                            <a href="#" className="bds_fbook" data-cmd="fbook" title="Share to Facebook"></a>
                            <a href="#" className="bds_twi" data-cmd="twi" title="Share to Twitter"></a>
                            <a href="#" className="bds_tsina" data-cmd="tsina" title="Share to Sina Weibo"></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="quality-check fl">
                        <div className="inner-wrap">
                            <ul className="clearfix">
                                <li className="tit">Quality Inspection</li>
                            ...
                            <div className="quality-check-people">
                                inspector：{this.props.videoData.checker}
                            </div>
                        </div>
                    </div>
                </div>
    ...
    render(){
        ...
        return(
            <div className="video-list">
                <div className="hd clearfix">
                    <h3 className="fl">Shop and buy</h3>
                    <div className="switch-btn fr" title="refresh" onClick={this.props.changeVideoListData}>refresh</div>
                </div>
                <div className="bd">
            ...
            .then(data=> {
                if (data.data.id) {
                    this.setState({
                        ...
                        document.title = this.state.video.title + document.title.replace(/^video/,'');
                    });
                }
            })
            .catch(error=> {
