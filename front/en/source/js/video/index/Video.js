...
export default class Video extends React.Component {
  ...
  componentDidMount() {
    ...
    window._bd_share_config = {
      common: {
        bdDesc    : 'SuperBuy Media Center',
        bdText    : 'SuperBuy Media Center',
        bdMini    : '2',
        bdMiniList: false,
        bdPic     : '',
        bdStyle   : '1',
      ...
      <div className="video">
        ...
        <div className="video-detail">
          <div className="left">
            ...
            <p className="view-number gray">{this.props.util.addThousandsSeparator(video.statistics.viewCount)}
              {' '}Played</p>
            <p className="description gray"
               ref="description">
              <span ref="description-text"
                    id="desc">{video.snippet.description}</span>
            </p>
            <p ref="toggle_btn"
               className={toggleBtn ? '' : 'hide'}>
              <a href="javascript:void(0)"
                 onClick={this.toggleDescription}>{descriptionOpen ? 'Close' : 'Open'}</a>
            </p>
          </div>
          <div className="right">
            <div><a className="go-youTube"
                    title="Watch in YouTube"
                    target="_blank"
                    href={`https://www.youtube.com/watch?list=${this.props.playlistId}&v=${this.props.currentVideo}`}>
              Watch in YouTube
            ...
            <div className="share-icon"
              ...
              <div id="bdshare"
                ...
                <a href="#"
                   ...
                   data-cmd="weixin"
                   title="Share to WeChat">{}</a>
                <a href="#"
                   className="bds_qzone"
                   data-cmd="qzone"
                   title="Share to QQ zone">{}</a>
                <a href="#"
                   className="bds_fbook"
                   data-cmd="fbook"
                   title="Share to Facebook">{}</a>
                <a href="#"
                   className="bds_twi"
                   data-cmd="twi"
