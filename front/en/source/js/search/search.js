...
let model = {
    ...
    prevPageTxt : 'Previous',
    nextPageTxt : 'Next',
    noResult : {
        tipTitle : ['Oops, can’t find',' ‘','’ ','or related items.'],
        tip : '<dt>Superbuy Recommendation:</dt> <dd>1.Try other keywords</dd> <dd>2.Check spelling</dd> <dd>3.Modify keywords, i.e. ‘autumn one-piece long dress’ modify as ‘ autumn dress’ or ‘one-piece long dress’</dd><dd>4.Contact us <a href="http://bbs.dotdotbuy.com/forum.php?mod=post&action=newthread&fid=42" target="_blank">Feedback></a></dd>',
        hotTitle : 'Superbuy Hot-Selling Products'
    }
};
