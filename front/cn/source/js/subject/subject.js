...
const staticData={
	brand:{"title":"优选品牌"},
	hotSell:{"add2ShopCar":"立即购买","selled":"已售罄","tagArr":["热销","新品","经典","爆款"]},
	beautifulClothes:{"add2ShopCar":"立即购买","selled":"已售罄","tagArr":["热销","新品","经典","爆款"]},
	ideas:{"title":"往期专题","more":"更多","disCount":"折起"}
}
let staticVar = {
	backColor:'#fff',
	suspendFontColor:'',
