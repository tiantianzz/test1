...
class Footer extends React.Component {
    ...
    initGoToTop(){
        ...
        let onScroll = ()=>{
            ...
            if(scrollTop  < clientHeight/2 === this.state.showBTT){
                this.setState((state)=>({
        ...
        onScroll();
        body.addEventListener(window.navigator.userAgent.indexOf('Firefox')!=-1 ? 'DOMMouseScroll' : 'mousewheel',onScroll,false);
    }
    handleBackToTop(){
        util.setScrollTop(0);
        this.setState(()=>({
            ...
            <footer className="m-footer" ref="footer">
                <div className="footer-wrap">
                    ...
                    <div className="footer-bottom">
                        ...
                        {/*{language === 1 && <p className="footer-copyRight">深圳市点点淘科技有限公司 版权所有</p>}*/}
                    </div>
