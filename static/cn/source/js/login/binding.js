...
/***/ function(module, exports, __webpack_require__) {
	...
	var ComponentBinding = function (_React$Component) {
		_inherits(ComponentBinding, _React$Component);

		function ComponentBinding(props) {
			_classCallCheck(this, ComponentBinding);

			var _this = _possibleConstructorReturn(this, (ComponentBinding.__proto__ || Object.getPrototypeOf(ComponentBinding)).call(this, props));
		...
		_createClass(ComponentBinding, [{
			...
			key: 'loginPasswordFocus',
			value: function loginPasswordFocus(e) {
			...
			key: 'bindingHandle',
			value: function bindingHandle() {
				var _this2 = this;

				var loginName = this.refs.loginName.value.toString().replace(/\+/g, "%2B").replace(/\&/g, "%26");
				var loginPsw = this.refs.loginPassword.value.toString().replace(/\+/g, "%2B").replace(/\&/g, "%26");
			...
			value: function hasExist() {
				...
				fetch(apiUrl + '/api/ajax/valid-email', {
					...
					if (data.state.toString() != '0') {
						emailTest(_this3.refs.registerName.value, {
			...
			value: function registerHandle(e) {
				...
				var registerUrl = apiUrl + '/api/connect/fillinfo';
				...
				fetch(apiUrl + '/api/ajax/valid-email', {
					...
					if (data.state.toString() != '0') {
						...
						emailTest(_this6.refs.registerName.value, {
						...
						fetch(apiUrl + '/api/ajax/valid-captcha', {
							...
							mode: 'cors',
							headers: { "Content-type": "application/x-www-form-urlencoded" },
							body: 'reg_captcha=' + _this6.refs.captcha.value
						}).then(function (response) {
							return response.json();
						}).then(function (data) {
							if (data.state.toString() != '0') {
			...
			key: 'haveAccountHandle',
			value: function haveAccountHandle(e) {
			...
			key: 'newAccountHandle',
			value: function newAccountHandle(e) {
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										'div',
										{ className: 'haveTitle accountTitle' },
										React.createElement(
											'span',
											{ onClick: this.haveAccountHandle.bind(this), ref: 'haveTxt' },
											this.props.loginTitle
										),
										React.createElement('img', { src: imgSrc + "login/up.png", ref: 'haveImg' })
									),
									React.createElement(
										'div',
										{ className: 'haveAccount', ref: 'haveAccount' },
										React.createElement(
											'div',
											{ className: 'loginMsg  emailAuto' },
											React.createElement('input', { type: 'text', id: 'loginEmail', value: this.state.login_name, list: 'loginList', ref: 'loginName', className: 'inputS', placeholder: this.props.email, onKeyDown: this.loginKeyDownHandle.bind(this), onChange: function onChange(e) {
													_this7.setState({ login_name: e.target.value });
										...
										React.createElement(
											'div',
											{ className: 'loginMsg' },
											React.createElement('input', { type: 'password', ref: 'loginPassword', className: 'inputS', placeholder: this.props.password, onKeyDown: this.loginKeyDownHandle.bind(this), onFocus: this.loginPasswordFocus.bind(this), onChange: function onChange(e) {
													return _this7.setState({ login_password: e.target.value });
												}, onBlur: this.loginPasswordTest.bind(this) }),
											React.createElement(
												'div',
												{ className: 'showPsw' },
										...
										React.createElement(
											...
											React.createElement('input', { type: 'button', ref: 'loginButton', onClick: this.bindingHandle.bind(this), className: 'btnS', value: this.state.loginLoading == true ? '' : this.props.subBtn }),
											React.createElement(
												'div',
								...
								React.createElement(
									...
									React.createElement(
										'div',
										{ className: 'newTitle accountTitle' },
										React.createElement(
											'span',
											{ onClick: this.newAccountHandle.bind(this), ref: 'newTxt' },
											this.props.registerTitle
										),
										React.createElement('img', { src: imgSrc + "login/down.png", ref: 'newImg' })
									),
									React.createElement(
										'div',
										{ className: 'newAccount', ref: 'newAccount' },
										React.createElement(
											'div',
											{ className: 'loginMsg emailAuto' },
											React.createElement('input', { type: 'text', id: 'registerEmail', list: 'registerList', ref: 'registerName', className: 'inputS', placeholder: this.props.email, onKeyDown: this.registerKeyDownHandle.bind(this), onChange: function onChange(e) {
													return _this7.setState({ register_name: e.target.value });
										...
										React.createElement(
											'div',
											{ className: 'loginMsg' },
											React.createElement('input', { type: 'password', ref: 'registerPassword', className: 'inputS', placeholder: this.props.password, onKeyDown: this.registerKeyDownHandle.bind(this), onFocus: this.registerPasswordFocus.bind(this), onChange: function onChange(e) {
													return _this7.setState({ register_password: e.target.value });
										...
										React.createElement(
											'div',
											{ className: 'loading-box' },
											React.createElement('input', { type: 'button', onClick: this.registerHandle.bind(this), ref: 'regButton', className: 'btnS registerBtn', value: this.state.registerLoading == true ? '' : this.props.subBtn }),
											React.createElement(
												'div',
	...
	ComponentBinding.defaultProps = {
		title: '验证成功',
		binding1: '为给您更好的服务,请绑定Superbuy账号',
		binding2: '如您还没有账号,请注册账号',
		loginTitle: '已有注册账号',
		registerTitle: '新账号注册',
		email: '邮箱',
		password: '密码',
	...
	ReactDOM.render(React.createElement(ComponentBinding, null), document.body);
