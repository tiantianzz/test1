				...
				return React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'h2',
							null,
							'7X24小时全天候在线服务　独家开通CEO邮箱'
						),
						React.createElement(
							'div',
							{ className: 'searchbox' },
							React.createElement('input', { placeholder: '输入问题的关键字进行搜索', ref: 'input', type: 'text', onKeyDown: this.keyDownHandle.bind(this) }),
							React.createElement(
								'a',
							...
							return React.createElement(
								...
								infos.list.map(function (item) {
									return React.createElement(
										...
										React.createElement(
											'a',
											{ target: '_blank', href: 'http://www.super.com/cn/page/help/#search_helpId' + item.helpId },
				...
				return React.createElement(
					...
					React.createElement(
							...
							servers.map(function (server) {
								return React.createElement(
									...
									React.createElement(
										'div',
										{ className: 'icon' },
										React.createElement('img', { className: 'img', name: server.name, src: supervar.imgsrc_cn + "/help/" + server.name + ".png" })
									),
									React.createElement(
										'h2',
										null,
						...
						React.createElement(
							...
							React.createElement(
								'a',
								{ className: 'more', target: '_blank', href: '/cn/page/video/index/' },
								'更多>'
							)
						),
						React.createElement(
								...
								videos.map(function (video) {
									return React.createElement(
										...
										React.createElement(
											...
											React.createElement(
												'a',
												{ href: '/cn/page/video/index/', target: '_blank' },
												React.createElement('img', { className: 'video-img', src: supervar.imgsrc_cn + "/help/" + video.videoImg })
											)
										),
										React.createElement(
											'div',
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									'div',
									{ className: 'icon' },
									React.createElement('img', { name: 'user', src: supervar.imgsrc_cn + "/help/user.png" })
								),
								React.createElement(
									'h2',
									null,
							...
							React.createElement(
								...
								React.createElement(
									'div',
									{ className: 'icon' },
									React.createElement('img', { name: 'server', src: supervar.imgsrc_cn + "/help/server.png" })
								),
								React.createElement(
									'h2',
									null,
							...
							React.createElement(
								'div',
								{ id: 'qq', className: 'contactbox', onMouseEnter: this.ActiveSever.bind(this), onMouseLeave: this.BlurServer.bind(this) },
								React.createElement(
									'div',
									{ className: 'icon' },
									React.createElement('img', { name: 'qq', src: supervar.imgsrc_cn + "/help/qq.png" })
								),
								React.createElement(
									'h2',
									null,
							...
							React.createElement(
								...
								React.createElement(
									'div',
									{ className: 'icon' },
									React.createElement('img', { name: 'cmail', src: supervar.imgsrc_cn + "/help/cmail.png" })
								),
								React.createElement(
									'h2',
									null,
