	        ...
	        value: function render() {
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement('a', { href: this.props.videoData.videoHref, title: '前往YouTube上观看', target: '_blank', className: 'go-youTube fl' }),
	                    React.createElement(
	                        'div',
	                        { className: 'share-icon fl', title: '分享视频' },
	                        React.createElement('i', { className: 'ico' }),
	                        React.createElement('div', { className: 'border-skip' }),
	                        React.createElement(
	                            'div',
	                            { id: 'bdshare', className: 'bdsharebuttonbox' },
	                            React.createElement('a', { href: '#', className: 'bds_weixin', 'data-cmd': 'weixin', title: '分享到微信' }),
	                            React.createElement('a', { href: '#', className: 'bds_qzone', 'data-cmd': 'qzone', title: '分享到QQ空间' }),
	                            React.createElement('a', { href: '#', className: 'bds_fbook', 'data-cmd': 'fbook', title: '分享到Facebook' }),
	                            React.createElement('a', { href: '#', className: 'bds_twi', 'data-cmd': 'twi', title: '分享到Twitter' }),
	                            React.createElement('a', { href: '#', className: 'bds_tsina', 'data-cmd': 'tsina', title: '分享到新浪微博' })
	                        )
	                    )
	                )
	            );
	        ...
	        value: function render() {
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'div',
	                        { className: 'switch-btn fr', title: '换一批', onClick: this.props.changeVideoListData },
	                        '换一批'
	                    )
	                ),
	                React.createElement(
	    ...
	    _createClass(Content, [{
	            ...
	            fetch(superbuyApiUrl + 'shoppingguide/video-info?id=' + this.state.id, {
	                ...
	                if (data.data.id) {
	                    _this8.setState({
	                        ...
	                        document.title = _this8.state.video.title + document.title.replace(/^视频播放/, '');
	                    });
	                }
	        ...
	        value: function render() {
	            ...
	            return React.createElement(
	                ...
	                React.createElement(VideoFrame, this.state),
	                React.createElement(
	                    'div',
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * ===数据
	 */
	var secnavTitle = [{ "title": "优选" }, { "title": "服饰" }, { "title": "数码" }, { "title": "家居" }, { "title": "鞋包" }];
