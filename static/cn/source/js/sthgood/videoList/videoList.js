	...
	var ListBox = function (_React$Component) {
	    ...
	    _createClass(ListBox, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            fetch(apiUrl + 'shoppingguide/video-cat-list').then(function (res) {
	                if (res.status === 200) {
	                    return res.json();
	                } else {
	        ...
	        value: function render() {
	            return React.createElement(
	                ...
	                React.createElement(
	                            ...
	                            React.createElement(
	                                ...
	                                React.createElement(
	                                    ...
	                                    React.createElement(
	                                        ...
	                                        this.state.videosData.totalRow || 0
	                                    ),
	                                    ' 个视频'
	                                ),
	                                React.createElement(
	                    ...
	                    React.createElement(_Pagination2.default, _extends({}, this.getPageConfig(), { onPage: this.onPageChange }))
	                )
	            );
	        }
	    }]);
