	...
	var Hotbrand = function (_React$Component2) {
	    ...
	    _createClass(Hotbrand, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            fetch('http://www.super.com/api/shoppingguide/recommend-brand?language=cn&debug=1', {
	                method: "GET"
	            }).then(function (res) {
	                return res.json();
	            }).then(function (data) {
	...
	var FindList = function (_React$Component3) {
	    ...
	    _createClass(FindList, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            fetch('http://www.super.com/api/shoppingguide/child-get-cat-list?language=cn&cat=' + this.props.name + '&currPage=1&pageSize=1&debug=1', {
	                method: "GET"
	            }).then(function (res) {
	                return res.json();
	            }).then(function (data) {
	...
	var Find = function (_React$Component4) {
	    ...
	    _createClass(Find, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            fetch(apiUrl + 'shoppingguide/child-cat-list?language=cn&debug=1', {
	                method: "GET"
	            }).then(function (res) {
	                return res.json();
	            }).then(function (data) {
