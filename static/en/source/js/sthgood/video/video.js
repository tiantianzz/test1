...
/***/ function(module, exports, __webpack_require__) {
	...
	var VideoFrame = function (_React$Component) {
	    _inherits(VideoFrame, _React$Component);

	    function VideoFrame() {
	        _classCallCheck(this, VideoFrame);

	        return _possibleConstructorReturn(this, (VideoFrame.__proto__ || Object.getPrototypeOf(VideoFrame)).apply(this, arguments));
	    }
	    ...
	    _createClass(VideoFrame, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            window.onload = function () {
	                ...
	                var updateCurrentVideo = _props.updateCurrentVideo;
	                var getVideoInfo = _props.getVideoInfo;

	                var currentVideoId = util.getQueryString('v', _this2.props.video.videoHref);
	                var player = new YT.Player(_this2.refs['player'], {
	                    height: '690',
	                    width: '1200',
	        ...
	        value: function render() {
	            return React.createElement(
	                ...
	                React.createElement(
	                    'div',
	                    { className: 'main-box' },
	                    React.createElement('div', { id: 'player', ref: 'player' })
	                )
	            );
	        }
	    }]);
	...
	var VideoDetail = function (_React$Component2) {
	    _inherits(VideoDetail, _React$Component2);
	    ...
	    _createClass(VideoDetail, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            window._bd_share_config = {
	                common: {
	                    bdDesc: this.props.videoData.title,
	                    bdText: this.props.videoData.title,
	                    bdMini: '2',
	                    bdMiniList: false,
	                    bdPic: '',
	                    bdStyle: '1',
	        ...
	        value: function render() {
	            ...
	            return React.createElement(
	                'div',
	                { className: 'video-detail clearfix' },
	                React.createElement(
	                    'div',
	                    { className: 'fl' },
	                    React.createElement(
	                ...
	                React.createElement(
	                    'div',
	                    { className: 'fr clearfix' },
	                    React.createElement('a', { href: this.props.videoData.videoHref, title: 'Watch on YouTube', target: '_blank', className: 'go-youTube fl' }),
	                    React.createElement(
	                        'div',
	                        { className: 'share-icon fl', title: 'Share Video' },
	                        React.createElement('i', { className: 'ico' }),
	                        React.createElement('div', { className: 'border-skip' }),
	                        React.createElement(
	                            'div',
	                            { id: 'bdshare', className: 'bdsharebuttonbox' },
	                            React.createElement('a', { href: '#', className: 'bds_weixin', 'data-cmd': 'weixin', title: 'Share to Wechat' }),
	                            React.createElement('a', { href: '#', className: 'bds_qzone', 'data-cmd': 'qzone', title: 'Share to QQ zone' }),
	                            React.createElement('a', { href: '#', className: 'bds_fbook', 'data-cmd': 'fbook', title: 'Share to Facebook' }),
	                            React.createElement('a', { href: '#', className: 'bds_twi', 'data-cmd': 'twi', title: 'Share to Twitter' }),
	                            React.createElement('a', { href: '#', className: 'bds_tsina', 'data-cmd': 'tsina', title: 'Share to Sina Weibo' })
	                        )
	                    )
	                )
	            );
	...
	var ProInfo = function (_React$Component3) {
	    _inherits(ProInfo, _React$Component3);

	    function ProInfo() {
	        _classCallCheck(this, ProInfo);

	        return _possibleConstructorReturn(this, (ProInfo.__proto__ || Object.getPrototypeOf(ProInfo)).apply(this, arguments));
	    }

	    _createClass(ProInfo, [{
	        key: 'render',
	        value: function render() {
	            return React.createElement(
	                'div',
	                ...
	                React.createElement(
	                    'div',
	                    { className: 'hd clearfix' },
	                    React.createElement(
	                        'div',
	                        { className: 'user fl' },
	                        React.createElement('img', { src: this.props.videoData.userImg, alt: this.props.videoData.nickName }),
	                        React.createElement(
	                            'span',
	                            { className: 'username' },
	                            this.props.videoData.nickName
	                        ),
	                        React.createElement(
	                            'span',
	                            null,
	                    ...
	                    React.createElement(
	                        'div',
	                        { className: 'fr video-info' },
	                        React.createElement(
	                            'span',
	                            { className: 'date' },
	                            this.props.date2str(new Date(this.props.videoData.createTime * 1000), "M-d")
	                        )
	                    )
	                ),
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'div',
	                        { className: 'pro-detail fl' },
	                        React.createElement(
	                            'div',
	                            { className: 'pic' },
	                            React.createElement('img', { src: this.props.videoData.img, alt: this.props.videoData.productTitle })
	                        ),
	                        React.createElement(
	                            'h3',
	                            { className: 'pro-name' },
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                ...
	                                this.props.videoData.price
	                            )
	                        )
	                    ),
	                    React.createElement(
	                        'div',
	                        { className: 'quality-check fl' },
	                        React.createElement(
	                            'div',
	                                ...
	                                React.createElement(
	                                    ...
	                                    React.createElement(
	                                        ...
	                                        React.createElement(
	                                            'span',
	                                            { className: 'label' },
	                                            this.props.videoData.checkContent
	                                        )
	                                    )
	                                ),
	                                React.createElement(
	                                    'li',
	                                    { className: 'intro' },
	                                    this.props.videoData.recommendContent
	                                )
	                            ),
	                            React.createElement(
	                                'div',
	                                { className: 'quality-check-people' },
	                                'inspector：',
	                                this.props.videoData.checker
	                            )
	                        )
	                    )
	                )
	...
	var VideoList = function (_React$Component4) {
	    _inherits(VideoList, _React$Component4);
	    ...
	    _createClass(VideoList, [{
	        ...
	        value: function renderListCont() {
	            ...
	            if (this.props.videosData.listResult) {
	                listCont = this.props.videosData.listResult.map(function (v, i) {
	                    return React.createElement(
	                        'li',
	                        { key: i, className: 'item', 'data-videoId': util.getQueryString('v', v.videoHref), 'data-id': v.id },
	                        React.createElement(
	                            'h3',
	                            { className: 'h3' },
	                            React.createElement(
	                                'a',
	                                { target: '_blank', href: v.href },
	                                v.productTitle
	                            )
	                        ),
	                        React.createElement(
	                            'a',
	                            { className: 'inner-wrap', target: '_blank', href: './index.html?id=' + v.id + (_this6.props.videosData.currPage > 1 ? '&page=' + _this6.props.videosData.currPage : '') },
	                            React.createElement(
	                                'div',
	                                { className: 'pic' },
	                            ...
	                            React.createElement(
	                                ...
	                                React.createElement(
	                                    ...
	                                    React.createElement(
	                                        'span',
	                                        { className: 'date fr' },
	                                        _this6.props.date2str(new Date(v.createTime * 1000), "M-d") || " "
	                                    )
	                                )
	                            )
	                        )
	        ...
	        value: function render() {
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'div',
	                        { className: 'switch-btn fr', title: 'refresh', onClick: this.props.changeVideoListData },
	                        'refresh'
	                    )
	                ),
	                React.createElement(
	...
	var superbuyApiUrl = window.supervar.apiURL;
	var config = {
	...
	var Content = function (_React$Component5) {
	    ...
	    function Content(props) {
	        ...
	        var currPage = util.getQueryString('page') * 1;
	        _this7.state = {
	            videos: { //存储视频分页基本信息
	                currPage: currPage || 1,
	                pageSize: 4,
	            ...
	            video: {}, //存储本视频单页面的视频信息
	            id: id ? id : _this7.props.id //在superbuy数据库对应的id编号
	            // currentVideoId : currentVideoId ? currentVideoId : props.currentVideoId //视频在youtube对应的id
	        };
	        _this7.updateCurrentVideo = _this7.updateCurrentVideo.bind(_this7);
	        _this7.getVideoInfo = _this7.getVideoInfo.bind(_this7);
	        _this7.getVideoList = _this7.getVideoList.bind(_this7);
	        _this7.changeVideoListData = _this7.changeVideoListData.bind(_this7);
	        return _this7;
	    }
	    ...
	    _createClass(Content, [{
	            ...
	            fetch(superbuyApiUrl + 'shoppingguide/video-info?id=' + this.state.id, {
	                ...
	                if (data.data.id) {
	                    _this8.setState({
	                        ...
	                        document.title = _this8.state.video.title + document.title.replace(/^video/, '');
	                    });
	                }
	        ...
	        value: function updateCurrentVideo(videoId, id) {//点击更换其他视频
	            //     this.setState({
	        ...
	        key: 'changeVideoListData',
	        value: function changeVideoListData() {
	            var _this10 = this;

	            //换一批视频
	            var totalPage = Math.ceil(this.state.videosData.totalRow / 4);
	            var currPage = this.state.videos.currPage;
	        ...
	        value: function render() {
	            ...
	            return React.createElement(
	                ...
	                React.createElement(VideoFrame, _extends({}, this.state, {
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(VideoDetail, { videoData: this.state.video }),
	                    React.createElement(ProInfo, { videoData: this.state.video, date2str: this.date2str }),
	...
	var content = ReactDOM.render(React.createElement(Wrap, { content: React.createElement(Content, config) }), document.getElementById("container"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/*icon*/\n/* public path */\n/* page width */\n/* css3.0 */\n/* 阴影 */\n/* 文字阴影 */\n/* 旋转 */\n/* 平移 */\n/* 缩放 */\n/* 扭曲 */\n/* transform */\n/* 渐变 */\n/* 三角形 */\n/* your business less */\n.mt15 {\n  margin-top: 15px;\n}\n.mt20 {\n  margin-top: 20px;\n}\n.mt25 {\n  margin-top: 25px;\n}\n.mt30 {\n  margin-top: 30px;\n}\n.main-box {\n  width: 1200px;\n  margin: 0 auto;\n}\n.video-frame {\n  width: 100%;\n  height: 690px;\n  background: url('/cn/source/img/sthgood/video/video_bg.jpg') center center no-repeat;\n  overflow: hidden;\n}\n.video-detail {\n  margin-top: 40px;\n}\n.video-detail h2 {\n  font-size: 25px;\n  line-height: 25px;\n  font-weight: bold;\n  width: 560px;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  word-break: break-all;\n  color: #333;\n}\n.video-detail .go-youTube {\n  display: inline-block;\n  width: 32px;\n  height: 25px;\n  background: url('/cn/source/img/sthgood/video/video_ico.png') no-repeat;\n  cursor: pointer;\n}\n.video-detail .share-icon {\n  position: relative;\n  margin-left: 20px;\n  height: 26px;\n}\n.video-detail .share-icon .ico {\n  position: relative;\n  z-index: 3;\n  display: inline-block;\n  width: 32px;\n  height: 26px;\n  background: url('/cn/source/img/sthgood/video/video_ico.png') -52px 0 no-repeat;\n  cursor: pointer;\n}\n.video-detail .share-icon .border-skip {\n  position: absolute;\n  top: -8px;\n  left: -7px;\n  z-index: 2;\n  border: 1px solid #b8b8b8;\n  border-bottom: none;\n  width: 45px;\n  height: 41px;\n  background: #fff;\n  display: none;\n}\n.video-detail .share-icon .bdsharebuttonbox {\n  position: absolute;\n  top: 33px;\n  left: -128px;\n  padding-left: 10px;\n  width: 156px;\n  height: 44px;\n  display: none;\n  border: 1px solid #b8b8b8;\n  background: #fff;\n}\n.video-detail .share-icon .bdsharebuttonbox a {\n  margin-top: 10px;\n}\n.video-detail .share-icon:hover {\n  background-color: #fff;\n  border-bottom: none;\n}\n.video-detail .share-icon:hover .border-skip {\n  display: block;\n}\n.video-detail .share-icon:hover .bdsharebuttonbox {\n  position: absolute;\n  display: block;\n  border: 1px solid #b8b8b8;\n  background: #fff;\n}\n.pro-info {\n  margin-top: 20px;\n}\n.pro-info .hd {\n  font-size: 16px;\n  color: #666;\n  line-height: 48px;\n}\n.pro-info .hd .user img {\n  width: 48px;\n  height: 48px;\n  -webkit-border-radius: 50%;\n  -moz-border-radius: 50%;\n  border-radius: 50%;\n  vertical-align: middle;\n}\n.pro-info .hd .username {\n  margin: 0 10px 0 15px;\n  color: #333;\n}\n.pro-info .hd .video-info {\n  line-height: 48px;\n  font-size: 14px;\n}\n.pro-info .hd .video-info .scan-num {\n  padding-left: 22px;\n  background: url('/cn/source/img/sthgood/videoList/video_ico.png') 0 3px no-repeat;\n  margin-right: 20px;\n}\n.pro-info .bd {\n  margin-top: 20px;\n}\n.pro-info .bd .pro-detail {\n  -moz-box-shadow: 5px 0 5px #f2f2f2;\n  -webkit-box-shadow: 5px 0 5px #f2f2f2;\n  box-shadow: 5px 0 5px #f2f2f2;\n  position: relative;\n  z-index: 1;\n  width: 320px;\n  height: 428px;\n  border: 1px solid #ddd;\n  padding: 30px;\n}\n.pro-info .bd .pro-detail img {\n  width: 318px;\n  height: 320px;\n}\n.pro-info .bd .pro-name {\n  margin-top: 15px;\n  line-height: 26px;\n  height: 52px;\n  overflow: hidden;\n  font-size: 20px;\n  text-overflow: -o-ellipsis-lastline;\n  text-overflow: ellipsis;\n  display: -webkit-box;\n  -webkit-line-clamp: 2;\n  -webkit-box-orient: vertical;\n}\n.pro-info .bd .price {\n  margin-top: 15px;\n  height: 20px;\n}\n.pro-info .bd .price i {\n  font-weight: normal;\n}\n.pro-info .bd .price .now-price {\n  font-weight: bold;\n  color: #e5515f;\n  font-size: 20px;\n}\n.pro-info .bd .price .old-price {\n  text-decoration: line-through;\n  color: #a0a0a0;\n  margin-left: 10px;\n}\n.pro-info .bd .quality-check {\n  width: 818px;\n}\n.pro-info .bd .quality-check .inner-wrap {\n  overflow: hidden;\n  padding: 0 30px;\n  height: 430px;\n  margin-top: 28px;\n  background: #f9f9f9 url('/cn/source/img/sthgood/video/quality-check.jpg') right 0 no-repeat;\n}\n.pro-info .bd .quality-check .basic-info {\n  margin-top: 20px;\n  color: #666;\n}\n.pro-info .bd .quality-check .basic-info .item {\n  line-height: 30px;\n}\n.pro-info .bd .quality-check .basic-info .label {\n  color: #999;\n}\n.pro-info .bd .quality-check .intro {\n  margin-top: 10px;\n  line-height: 24px;\n  text-indent: 3em;\n  color: #999;\n  height: 194px;\n  border-bottom: 1px solid #eee;\n  word-break: break-all;\n  display: -webkit-box;\n  -webkit-line-clamp: 8;\n  -webkit-box-orient: vertical;\n  overflow: hidden;\n}\n.pro-info .bd .quality-check .tit {\n  font-size: 20px;\n  margin-top: 40px;\n  line-height: 20px;\n}\n.pro-info .bd .quality-check-people {\n  font-size: 16px;\n  padding: 10px 20px 0  0;\n  text-align: right;\n  color: #666;\n}\n.video-list .list-ul {\n  margin: 0 0 60px -20px;\n}\n.video-list .no-data {\n  line-height: 160px;\n  font-size: 18px;\n  color: #999;\n  text-align: center;\n}\n.video-list .hd {\n  margin-top: 40px;\n  padding-bottom: 12px;\n  border-bottom: 1px solid #ddd;\n  color: #333;\n}\n.video-list .hd h3 {\n  font-size: 18px;\n}\n.video-list .hd .switch-btn {\n  line-height: 28px;\n  padding-left: 30px;\n  background: url('/cn/source/img/sthgood/video/video_ico.png') -68px -32px no-repeat;\n  color: #999;\n  cursor: pointer;\n  -webkit-user-select: none;\n  -moz-user-select: none;\n  -ms-user-select: none;\n  user-select: none;\n}\n.video-list .item {\n  -webkit-transition: all 0.25s ease-in-out;\n  -moz-transition: all 0.25s ease-in-out;\n  -ms-transition: all 0.25s ease-in-out;\n  -o-transition: all 0.25s ease-in-out;\n  transition: all 0.25s ease-in-out;\n  position: relative;\n  width: 283px;\n  border: 1px solid #eee;\n  margin: 20px 0 0 20px;\n  float: left;\n}\n.video-list .item img {\n  width: 100%;\n  height: 100%;\n}\n.video-list .item a {\n  cursor: pointer;\n  text-decoration: none;\n}\n.video-list .item .inner-wrap {\n  display: block;\n}\n.video-list .item .pic {\n  position: relative;\n  width: 283px;\n  height: 160px;\n}\n.video-list .item .pic .video-tit {\n  position: absolute;\n  top: 0px;\n  left: 0px;\n  z-index: 3;\n  width: 263px;\n  padding: 0 10px;\n  height: 160px;\n  line-height: 160px;\n  text-align: center;\n  color: #fff;\n  font-size: 16px;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  word-break: break-all;\n}\n.video-list .item .pic .tip {\n  position: absolute;\n  bottom: 10px;\n  left: 10px;\n  z-index: 3;\n  width: 264px;\n  color: #fff;\n  line-height: 16px;\n  height: 16px;\n}\n.video-list .item .pic .ico {\n  display: inline-block;\n  width: 25px;\n  height: 25px;\n  background: url('/cn/source/img/sthgood/videoList/video_ico.png') 0 -25px no-repeat;\n}\n.video-list .item .pic .mask {\n  position: absolute;\n  top: 0;\n  left: 0;\n  z-index: 2;\n  width: 100%;\n  height: 100%;\n  background: rgba(20, 35, 65, 0.5);\n  display: block;\n}\n.video-list .item h3 {\n  position: absolute;\n  top: 175px;\n  left: 10px;\n  width: 263px;\n  height: 12px;\n  line-height: 12px;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  word-break: break-all;\n}\n.video-list .item h3 a {\n  color: #333;\n}\n.video-list .item .txt {\n  margin-top: 40px;\n  padding: 0 10px;\n}\n.video-list .item .txt .price {\n  margin-top: 15px;\n  line-height: 14px;\n  margin-left: -3px;\n}\n.video-list .item .txt .price i {\n  font-weight: normal;\n  font-style: normal;\n}\n.video-list .item .txt .price .now-price {\n  font-weight: bold;\n  color: #e5515f;\n  font-size: 16px;\n}\n.video-list .item .txt .price .old-price {\n  text-decoration: line-through;\n  color: #cbcbcb;\n  margin-left: 10px;\n}\n.video-list .item .txt .label {\n  margin-top: 25px;\n  padding-left: 20px;\n  border-bottom: 1px solid #eee;\n  background: url('/cn/source/img/sthgood/videoList/video_ico.png') 0 -13px no-repeat;\n  color: #666;\n  overflow: hidden;\n}\n.video-list .item .txt .label ul {\n  margin-left: -20px;\n  padding-bottom: 10px;\n}\n.video-list .item .txt .label li {\n  float: left;\n  margin-left: 20px;\n  font-size: 12px;\n  line-height: 12px;\n}\n.video-list .item .txt .label a {\n  color: #666;\n  cursor: pointer;\n}\n.video-list .item .txt .foot {\n  padding: 10px 0 15px 0;\n  color: #666;\n  height: 12px;\n  line-height: 12px;\n  overflow: hidden;\n}\n.video-list .item .txt .foot .scan-num {\n  padding-left: 22px;\n  background: url('/cn/source/img/sthgood/videoList/video_ico.png') 0 2px no-repeat;\n}\n.video-list .item:hover {\n  -moz-box-shadow: 0px 5px 8px #d5d5d5;\n  -webkit-box-shadow: 0px 5px 8px #d5d5d5;\n  box-shadow: 0px 5px 8px #d5d5d5;\n  -moz-transform: translate(0, -6px);\n  -webkit-transform: translate(0, -6px);\n  -o-transform: translate(0, -6px);\n  transform: translate(0, -6px);\n}\n.video-list .item:hover .tip {\n  opacity: 0.5;\n}\n.video-list .item:hover .video-tit {\n  color: rgba(255, 255, 255, 0.5);\n}\n.video-list .item:hover .mask {\n  background: rgba(0, 0, 0, 0.7) url('/cn/source/img/sthgood/videoList/video_hover_ico.png') center no-repeat;\n}\n", ""]);
